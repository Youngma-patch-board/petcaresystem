 ...
 */
function _buildSalt() {
  // 각 조각을 분산 배치: "pc28_" + "v2slt" + year calc
  const a = String.fromCharCode(112, 99, 50, 56, 95, 118, 50); // "pc28_v2"
  const b = String.fromCharCode(115, 108, 116, 95); // "slt_"
  const c = ((new Date().getFullYear() - 2000) * 7 + 13).toString(16); // 동적 연도 기반
  return a + b + c;
}
